...
import { Brand, Button, ButtonType, Navbar } from 'react-tablerui';
        ...
        <div className="navbar-nav flex-row order-md-last">
          <div className="nav-item d-none d-md-flex me-3">
            <div className="btn-list">
              <Button href="https://github.com/AngelAlexQC/react-tablerui">
                <BrandGithub />
                Source code
              </Button>
            </div>
          ...
          <div className="nav-item dropdown">
            ...
            >
              <span
                ...
                style={{
                  backgroundImage:
                    'url(https://avatars.githubusercontent.com/u/9358510?v=4)',
                }}
              ></span>
              <div className="d-none d-xl-block ps-2">
                <div>Ángel Quiroz</div>
                <div className="mt-1 small text-muted">FullStack Developer</div>
              </div>
            </a>
